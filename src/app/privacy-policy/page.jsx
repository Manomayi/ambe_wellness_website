  ...
  return (
    <main className="min-h-screen bg-gray-50 py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl bg-white shadow-sm rounded-2xl p-8 sm:p-12">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-8 pb-4 border-b">Privacy Policy</h1>
...
Website refers to Ambe Wellness, accessible from [https://ambewellness.com/](https://ambewellness.com/)
