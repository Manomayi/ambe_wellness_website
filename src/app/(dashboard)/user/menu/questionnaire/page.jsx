...
const options = [
  ...
  ["Good short term, quick to forget","Medium but accurate","Slow to reuser but then sustained"],
...
export default function QuestionnairePage() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      const qRef = doc(db, 'users', user.uid, 'questionnaires', 'dosha_questionnaire')
      batch.set(qRef, {
