    ...
    <ProtectedRoute userType="user">
      <div className="max-w-6xl mx-auto p-6 space-y-8">
            ...
            <div className="space-y-3">
              {thingsToDoTasks.map((task) => (
                <button
                  ...
                  className="w-full bg-black bg-opacity-45 border border-green-300 rounded-lg p-4 hover:bg-opacity-55 transition text-left"
                >
        ...
        <div>
          ...
          <div className="bg-black bg-opacity-45 border border-green-300 rounded-lg p-4">
