...
import { EnterpriseRoiGrid } from '@/components/enterprise/EnterpriseRoiStats';
...
export default function Enterprise() {
  ...
  return (
    <div className="ent-page min-h-screen bg-white">
          ...
          <div className="w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-16">
            <div className="max-w-3xl">
              ...
              <p className="ent-hero-sub">
                From warehouse floors to executive suites — we have helped companies elevate their culture, retention, and ROI.
              </p>
            </div>
      ...
      {/* Continuous Video Background Wrapper for Sections down to Bring Ambe */}
      <div className="relative ent-video-section">
        <VideoBackground className="ent-video" />
        <div className="ent-video-overlay" aria-hidden />
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16">
              <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16">
                ...
                <div className="w-full lg:flex-1">
                  <div 
                    className="font-heading font-normal not-italic mb-6 lg:mb-8 text-2xl sm:text-3xl md:text-4xl text-center lg:text-left text-[#F4F1EA]" 
                    style={{ color: '#F4F1EA' }}
                  >
                    Proven Track Record
                  </div>
                  <p className="text-base sm:text-lg leading-relaxed text-center lg:text-left text-[#F4F1EA]/90" style={{ color: '#F4F1EA' }}>
          ...
          <section className="py-12 sm:py-16 md:py-20 border-t border-white/10">
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16">
              ...
              <div className="text-center mb-8 sm:mb-12 md:mb-16">
                <div 
                  className="font-heading font-normal not-italic mb-4 text-2xl sm:text-3xl md:text-4xl text-[#F4F1EA]" 
                  style={{ color: '#F4F1EA' }}
                >
                  Personalized, Holistic Care
                </div>
                <p className="text-base sm:text-lg px-4 sm:px-0 text-[#F4F1EA]/85" style={{ color: '#F4F1EA' }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div className="bg-[#1A1A1A]/80 backdrop-blur-md p-6 sm:p-8 text-center rounded-2xl border border-white/15">
                  <div className="mb-6 sm:mb-8 flex justify-center">
                    <div className="w-16 h-16 rounded-full bg-white/20 flex items-center justify-center p-3">
                      <Image
                  ...
                  <div className="text-lg sm:text-xl font-semibold mb-4 text-[#F4F1EA]" style={{ color: '#F4F1EA' }}>
                ...
                <div className="bg-[#1A1A1A]/80 backdrop-blur-md p-6 sm:p-8 text-center rounded-2xl border border-white/15">
                  ...
                  <p className="text-sm text-[#F4F1EA]/80" style={{ color: '#F4F1EA' }}>
                    (including classes in Mandarin, Spanish, and more)
                  </p>
                </div>

                {/* Card 3 - Holistic Modalities */}
                <div className="bg-[#1A1A1A]/80 backdrop-blur-md p-6 sm:p-8 text-center sm:col-span-2 lg:col-span-1 rounded-2xl border border-white/15">
                  <div className="mb-6 sm:mb-8 flex justify-center">
                    <div className="w-16 h-16 rounded-full bg-white/20 flex items-center justify-center p-3">
                      <Image
              ...
              <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16">
                ...
                <div className="w-full lg:flex-1 space-y-6 sm:space-y-8 order-2 lg:order-2">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 rounded-full flex items-center justify-center flex-shrink-0 bg-white/20">
                      <Image
                    ...
                    <p className="text-sm sm:text-base leading-relaxed pt-2 sm:pt-3 text-[#F4F1EA]">
