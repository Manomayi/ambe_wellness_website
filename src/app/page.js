    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-20 w-full flex justify-center">
          <div className="w-full max-w-7xl px-6 sm:px-8 lg:px-16">
            <div className="max-w-3xl">
              <div className={bannerTitleClasses + " mb-4 leading-tight text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl"} style={{ color: 'white' }}>
                Integrative-Doctor led care<br />
                Pay as you like
              </div>
              <p className="text-white mb-2 text-sm sm:text-base md:text-lg lg:text-xl font-light" style={{ color: 'white' }}>
                Evidence based holistic care with heart<br />
                Tailored only for you
              </p>
              <p className="text-white mb-4 sm:mb-8 text-sm sm:text-base" style={{ color: 'white' }}>
                Tele-Wellness
              </p>
              <p className="text-white mb-6 sm:mb-8 text-sm sm:text-base font-bold" style={{ color: 'white' }}>
      ...
      <section className="py-12 sm:py-16 md:py-20" style={{ backgroundColor: '#E5E5E5' }}>
        <div className="max-w-7xl mx-auto px-0 sm:px-6 lg:px-8">
          <div className="mb-8 sm:mb-12 text-center xl:text-left px-4">
            <div className={sectionTitleClasses + " mb-2 text-xl sm:text-2xl md:text-3xl lg:text-4xl"}>Trusted by:</div>
            <div className="font-bold mb-4 text-xl sm:text-2xl md:text-3xl lg:text-4xl" style={{ color: '#353535' }}>American Apparel™</div>
            <p className="text-sm sm:text-base lg:text-lg" style={{ color: '#535353' }}>Pioneers In Corporate Wellness: A Better Way To Grow</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
            ...
            <div className="relative flex justify-center px-4 md:px-0">
              <div className="rounded-full p-4 sm:p-4 md:p-6 lg:p-6 xl:p-5 flex flex-col items-center w-[calc(100vw-32px)] md:w-[400px] lg:w-[400px] xl:w-[400px] max-w-[380px] md:max-w-none h-[calc(100vw-32px)] md:h-[400px] lg:h-[400px] xl:h-[400px] max-h-[380px] md:max-h-none" style={{ backgroundColor: '#FFD3AC' }}>
                ...
                <div className="text-sm sm:text-base md:text-lg font-semibold text-center mb-3 min-h-[2.5rem] sm:min-h-[3rem] flex items-center" style={{ color: '#353535' }}>
                  Chief Strategy Officer,<br />National Tech Firm
                </div>
                <p className="text-xs sm:text-sm text-center leading-relaxed flex-1 flex items-start px-2" style={{ color: '#353535' }}>
                ...
                <p className="text-center font-semibold mt-3 sm:mt-4 text-sm sm:text-base" style={{ color: '#353535' }}>David</p>
              </div>
            </div>
            ...
            <div className="relative flex justify-center px-4 md:px-0">
              <div className="rounded-full p-4 sm:p-4 md:p-6 lg:p-6 xl:p-5 flex flex-col items-center w-[calc(100vw-32px)] md:w-[400px] lg:w-[400px] xl:w-[400px] max-w-[380px] md:max-w-none h-[calc(100vw-32px)] md:h-[400px] lg:h-[400px] xl:h-[400px] max-h-[380px] md:max-h-none" style={{ backgroundColor: '#FFD3AC' }}>
                ...
                <p className="text-center font-semibold mt-3 sm:mt-4 text-sm sm:text-base" style={{ color: '#353535' }}>Joshua</p>
              </div>
            </div>
            ...
            <div className="relative flex justify-center px-4 md:px-0 md:col-span-2 xl:col-span-1">
              <div className="rounded-full p-4 sm:p-4 md:p-6 lg:p-6 xl:p-5 flex flex-col items-center w-[calc(100vw-32px)] md:w-[400px] lg:w-[400px] xl:w-[400px] max-w-[380px] md:max-w-none h-[calc(100vw-32px)] md:h-[400px] lg:h-[400px] xl:h-[400px] max-h-[380px] md:max-h-none" style={{ backgroundColor: '#FFD3AC' }}>
                ...
                <p className="text-center font-semibold mt-3 sm:mt-4 text-sm sm:text-base" style={{ color: '#353535' }}>Rosario</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center px-4">
            <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl" style={{ color: '#353535' }}>
      ...
      <section className="py-12 sm:py-16 md:py-20" style={{ backgroundColor: '#F4F4F4' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={sectionTitleClasses + " text-center mb-4 sm:mb-6 text-2xl sm:text-3xl md:text-4xl"}>
            Time Tested and Results Driven
          </div>
          <p className="text-center text-base sm:text-lg mb-8 sm:mb-12 md:mb-16 max-w-5xl mx-auto px-4" style={{ color: '#535353' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8 sm:mb-12 md:mb-16">
            ...
            <div className="text-center bg-white p-6">
              ...
              <div className="text-lg sm:text-xl font-semibold mb-4" style={{ color: '#353535' }}>
                ...
                <span className="sm:hidden">Conflicted by fad-driven advice and </span>endless tests without real insight?
              </div>
            ...
            <div className="text-center bg-white p-6">
              ...
              <div className="text-lg sm:text-xl font-semibold mb-4" style={{ color: '#353535' }}>
                ...
                <span className="sm:hidden">Tired of one-size-fits-all </span>supplements?
              </div>
              <p className="text-sm leading-relaxed" style={{ color: '#535353' }}>
            ...
            <div className="text-center bg-white p-6">
              ...
              <div className="text-lg sm:text-xl font-semibold mb-4" style={{ color: '#353535' }}>
                ...
                <span className="sm:hidden">Being overcharged by underqualified, </span>self-professed experts?
              </div>
              <p className="text-sm leading-relaxed" style={{ color: '#535353' }}>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-8 lg:gap-x-16 xl:gap-x-32 gap-y-8 sm:gap-y-12 md:gap-y-16">
            ...
            <div className="space-y-8 sm:space-y-12 md:space-y-16">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 md:gap-8 text-center sm:text-left">
                ...
                />
                <div className="flex-1">
                  <div className="text-xl sm:text-2xl font-semibold mb-2" style={{ color: '#353535' }}>Book</div>
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 md:gap-8 text-center sm:text-left">
                ...
                />
                <div className="flex-1">
                  <div className="text-xl sm:text-2xl font-semibold mb-2" style={{ color: '#353535' }}>Video Call</div>
                  <p className="text-sm sm:text-base leading-relaxed" style={{ color: '#535353' }}>
            ...
            <div className="space-y-8 sm:space-y-12 md:space-y-16">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 md:gap-8 text-center sm:text-left">
                ...
                />
                <div className="flex-1">
                  <div className="text-xl sm:text-2xl font-semibold mb-2" style={{ color: '#353535' }}>Get Care + Unlimited Text</div>
                  <p className="text-sm sm:text-base leading-relaxed" style={{ color: '#535353' }}>
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 md:gap-8 text-center sm:text-left">
                ...
                />
                <div className="flex-1">
                  <div className="text-xl sm:text-2xl font-semibold mb-2" style={{ color: '#353535' }}>Monthly Video Follow Up</div>
                  <p className="text-sm sm:text-base leading-relaxed" style={{ color: '#535353' }}>
            ...
            <table className="w-full min-w-[640px]">
              ...
              <tbody>
                ...
                <tr className="border-t border-gray-200">
                  ...
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-base sm:text-lg md:text-xl text-charcoal">X</td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-charcoal text-xs sm:text-sm md:text-base">$ 500/Visit</td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-base sm:text-lg md:text-xl text-charcoal">X</td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-base sm:text-lg md:text-xl text-charcoal">X</td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-base sm:text-lg md:text-xl text-charcoal">X</td>
                </tr>
                ...
                <tr className="border-t border-gray-200">
                  ...
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-charcoal text-xs sm:text-sm md:text-base">Infrequently</td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-base sm:text-lg md:text-xl text-charcoal">X</td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-base sm:text-lg md:text-xl text-charcoal">X</td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-base sm:text-lg md:text-xl text-charcoal">X</td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-base sm:text-lg md:text-xl text-charcoal">X</td>
                ...
                <tr className="border-t border-gray-200">
                  ...
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center">
                    <div className="inline-flex items-center justify-center px-2 sm:px-3 md:px-4 py-2 sm:py-3 rounded-xl sm:rounded-2xl bg-[#FFD3AC]">
                      <span className="text-xs sm:text-sm text-charcoal">100 tests = $100</span>
                    </div>
                  </td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-xs sm:text-sm text-charcoal">100 tests =<br />min $300</td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-charcoal text-xs sm:text-sm md:text-base">$250</td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center text-base sm:text-lg md:text-xl text-charcoal">X</td>
                  <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 text-center">
                    <div className="inline-flex items-center justify-center w-20 sm:w-24 md:w-32 h-10 sm:h-12 md:h-16 rounded-xl sm:rounded-2xl bg-[#FFD3AC]">
                      <CheckIcon className="w-4 sm:w-5 md:w-6 h-4 sm:h-5 md:h-6 text-charcoal" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
            ...
            <div className="w-full lg:flex-1">
              <div className="relative overflow-hidden h-[250px] sm:h-[300px] md:h-[350px] lg:h-[400px] w-full mx-auto max-w-md lg:max-w-none" style={{ borderRadius: '0 150px 0 150px' }}>
                <Image 
            ...
            {/* Right Content */}
            <div className="w-full lg:flex-1">
              <div className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6" style={{ color: '#353535' }}>
                Bio markers and holistic integration
              </div>
              <p className="text-sm sm:text-base leading-relaxed" style={{ color: '#535353' }}>
          ...
          <div className="py-12 sm:py-16 md:py-24">
            ...
            <div className="max-w-5xl mx-auto px-6 sm:px-8">
              <div className="relative">
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 -top-8 sm:-top-10 w-16 sm:w-20 h-16 sm:h-20 rounded-full flex items-center justify-center z-10" style={{ backgroundColor: '#E5E5E5' }}>
                  <span className="text-3xl sm:text-4xl" style={{ color: '#FFD3AC' }}>&ldquo;</span>
                </div>
                
                {/* Container */}
                <div className="rounded-2xl sm:rounded-3xl pt-16 sm:pt-20 pb-12 sm:pb-16 px-6 sm:px-8 md:px-12" style={{ backgroundColor: 'rgba(244, 244, 244, 0.7)' }}>
                  <div className="max-w-4xl mx-auto text-center">
                    {/* First paragraph */}
                    <p className="text-sm sm:text-base md:text-lg mb-3 sm:mb-4" style={{ color: '#353535' }}>
                      We&apos;re doctors, entrepreneurs and researchers with decades of experience.
                    </p>
                    <p className="text-sm sm:text-base md:text-lg mb-8 sm:mb-12" style={{ color: '#353535' }}>
                      Ambé is built for the soul of the modern man.
                    </p>
                    
                    {/* Main Quote */}
                    <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light leading-tight mb-8 sm:mb-12" style={{ color: '#353535', fontFamily: 'Playfair Display, serif' }}>
                      With loving support, we can blossom into<br className="hidden sm:block" />
                      <span className="sm:hidden">With loving support, we can blossom into </span>our full potential.
                    </div>

                    {/* Attribution */}
                    <p className="text-right text-sm sm:text-base md:text-lg" style={{ color: '#353535' }}>
                      -Founder
                    </p>
                  </div>
                </div>
            ...
            <div className="max-w-5xl mx-auto px-6 sm:px-8 mt-8 sm:mt-12 md:mt-16">
              <div className="rounded-2xl sm:rounded-3xl py-8 sm:py-10 md:py-12 px-6 sm:px-8 md:px-12" style={{ backgroundColor: 'rgba(244, 244, 244, 0.7)' }}>
                <p className="text-sm sm:text-base leading-relaxed text-center" style={{ color: '#353535' }}>
                  Ten trees planted per member, per month = 120 trees per year per member. Our health depends<br className="hidden md:block" />
                  <span className="md:hidden">Ten trees planted per member, per month = 120 trees per year per member. Our health depends </span>
                  on the health of Mother Nature — trees are proven to be the #1 way to purify and nourish the<br className="hidden md:block" />
                  <span className="md:hidden">on the health of Mother Nature — trees are proven to be the #1 way to purify and nourish the </span>
