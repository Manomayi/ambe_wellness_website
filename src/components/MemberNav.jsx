...
export default function MemberNav({ currentPath }) {
  const tabs = [
    { label: 'Home',    href: '/member/home',    Icon: HomeIcon },
    { label: 'Consult', href: '/member/consult', Icon: ChatBubbleLeftEllipsisIcon },
    { label: 'Store',   href: '/member/store',   Icon: ShoppingCartIcon },
    { label: 'Menu',    href: '/member/menu',    Icon: UserCircleIcon },
  ];

  return (
    <header className="sticky top-0 z-50 bg-white bg-opacity-90 backdrop-blur-sm shadow-sm">
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between h-16">
        <div className="text-2xl font-bold text-green-600">Ambe Member</div>
